...
function datos_producto_obtenido_por_escaner () {
    if (isset($_SESSION["producto_obtenido_por_escaner"])) {
        ...
        echo "<div id='datos-input-escaner' data-id_producto='$id_producto' data-nombre='$nombre_producto' data-stock_actual='$stock_actual' data-codigo_de_barra='$codigo_de_barra' data-unidad='$nombre_unidad'  data-precio='$precio' data-requiere_fecha_vencimiento='$requiere_fecha_vencimiento'></div>";
    } else {
